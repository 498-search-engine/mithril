...
private:
    ...
    static void initialize_internal() {
        stopwords_ = {
            ...
            "some", "any", "all", "no", "every", "each", "few", "more", "most", "other", "such", "what", "which", "whose",
            // Pronouns
            "i", "me", "my", "mine", "myself",
            ...
            "about", "above", "across", "after", "afterwards", "again", "against", "along", "already", "also", "although", "always",
            "am", "among", "amongst", "amount", "and", "another", "anyhow", "anyone", "anything", "anyway", "anywhere",
            ...
            "cry", "de", "describe", "detail", "do", "done", "down", "due", "during", "eg", "eight", "either", "eleven", "else",
            ...
            "have", "having", "hence", "her", "here", "hereafter", "hereby", "herein", "hereupon", "hers", "herself", "him",
            ...
            "somewhere", "still", "such", "system", "take", "ten", "than", "that", "the", "their", "theirs", "them", "themselves",
    ...
    static void ensureInitialized() {
        std::call_once(init_flag_, initialize_internal);
    }
